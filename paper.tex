...
\begin{equation}\label{tfric}
    t_{fric} = \frac{19}{6}Gyr\left(\frac{R_e}{5kpc}\right)^2\frac{\sigma_{eff}}{200km\,s^{-1}}\frac{10^8\,M_{\odot}}{M_{bh}}
\end{equation}
