%\documentclass[english, backref,breaklinks,colorlinks,citecolor=blue, usenatbib]{mnras}
%\usepackage{amsbsy}
%\usepackage{amsmath}
%\usepackage{amstext}
...
We performed N-body simulations on 11 galaxies ranging in mass between $10^{12}$ M$_{\sun}$ < M < $10^{13}$ M$_{\sun}$, from 4 $\gid$ z $\gid$ 0.  We found that 42$\%$ of the orbiting black holes merged with their host galaxy, while another 43$\%$ remained in orbit at $z=0$.  With an x-ray luminosity range of $10^{25}-10^{43}$ $erg\ s^{-1}$.
