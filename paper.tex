...
\textbf{The vast majority of the full set of galaxies (1,537) were eliminated because they did not come into existence until after $z=4$.  Of the remaining 293 galaxies, 67 of them existed at z=0, and 51 of them also had black holes orbiting at z=0}.  In considering time and resources, we chose the 11 galaxies that had the largest number black holes to run the simulations.  The black holes in these galaxies accounted for nearly $84{\%}$ of all orbiting black holes across all the galaxies, so it represented a reasonable balance between completeness and efficiency.
