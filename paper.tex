...
\begin{subequations}
    ...
    \begin{equation}\label{mdotb}
        \dot{m}_{B} = \dot{M}_{B}/\dot{M}_{Edd},
    \end{equation}
...
\caption{X-ray Luminosity Distribution of Orbiting BHs at z=0.  Green region under curve represents approximate range of detectable orbiting black holes. The dashed, red vertical line is the median X-ray luminosity of our sources ($1.0\times10^{33}\;\text{erg}\;\text{s}^{-1}$).}
\label{fig:ldobhs}
\end{center}
\end{figure}
