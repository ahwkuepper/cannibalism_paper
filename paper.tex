...
\begin{abstract}
We perform N-body simulations on 13 galaxies extracted from a cosmological simulation of hierarchical structure formation with total mass $10^{12} \msun < M < 10^{13} \msun$ from $4 \ge z \ge 0$.  We track the dynamical evolution of the orbiting black holes (BHs) around their host central BH.  Of the 120 orbiting BHs, we find that 50 merge with their host central BHs, 11 are ejected from their respective host galaxies, and 59 are still orbiting at the end of the simulations.  48 BHs are kicked to a higher orbit after close interaction with the central BH, after which none of them merge with their host.  We calculate the x-ray luminosities of the orbiting BHs at z=0, and find a range of $10^{18}-10^{37}$ $erg\ s^{-1}$.
\end{abstract}
...
The net black hole mass accretion rate is approximated by [DO I REFERENCE INAYOSHI, OR ANOTHER SOURCE?]:
\begin{equation}
...
\begin{figure}[htp]
\begin{center}
\includegraphics[width=1.0\columnwidth]{plots/Galaxy_Gas_Compared_to_Babyk.png}
